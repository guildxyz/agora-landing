...
<div class={`mx-auto max-w-sm flex flex-col items-center text-md ${_class}`}>
  <img src={image} {alt} class="mb-8 h-52 2xl:h-72" />
  <p class="mb-3 text-agora-white lg:font-semibold 2xl:text-lg">
    “<span class="text-agora-pink-light">{quoteStart}</span><br />
    {quote}”
  </p>
