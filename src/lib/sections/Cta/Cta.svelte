<script>
  import CtaImg from './components/CtaImg.svelte';
</script>

<section id="join-or-create-a-community" class="relative bg-agora-blue-medium overflow-hidden">
  <!-- Background circles -->
  <div
  ...
  <div
    class="container grid gap-16 md:gap-0 md:grid-cols-2 mx-auto px-8 pt-16 lg:pt-20 xl:pt-40 pb-20 lg:pb-24 xl:pb-44"
  >
    <CtaImg
