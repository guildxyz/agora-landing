<section id="what-is-agora-space" class="relative bg-agora-purple">
  <div class="relative w-full max-fullhd-container mx-auto flex flex-col">
    <div
      class="flex flex-col lg:flex-row justify-end px-8 pt-16 md:pt-20 lg:py-28 xl:py-48 text-agora-white"
    >
      <div
      ...
      >
        <img
          ...
          class="w-full h-full pt-16 object-cover lg:object-contain object-left-bottom"
        />
      </div>

      <div class="order-1 lg:order-2 container lg:mr-0 lg:w-3/5 lg:pl-20 text-center">
        <h2
