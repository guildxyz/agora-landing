<script>
  ...
  let baseClasses =
    'flex items-center justify-center space-x-3 border border-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-300 focus-visible:ring-opacity-50';
